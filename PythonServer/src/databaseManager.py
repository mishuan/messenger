...
class DatabaseManager:
    ...
    def _constructQuery(self, eQueryType, sTableName, listParams, listValues, sCondition = ""):
        """
...
#     sConversionsTableName = "Conversations"
    ...
    def insertUser(self, sUserName, sTimestamp = None):
        ...
        log(DEBUG, "checking if user exists: {} {}".format(response, bNoResponse, isinstance(response, list)))
