...
class Timestamp:
    ...
    @staticmethod
    # def getNumberOfSecondsFromString(sTimestamp):
    #     timestamp = Timestamp._getRawTimeFromString(sTimestamp)
    #     sTotalSeconds = None
    #     if isinstance(timestamp, datetime):
    #         sTotalSeconds = timestamp.strftime("%s")

    #     log(DEBUG, "sTimestamp={}; timestamp={}; sTotalSeconds={}".format(sTimestamp, timestamp, sTotalSeconds))
